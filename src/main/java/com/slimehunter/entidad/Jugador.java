...
public class Jugador extends Entidad {
	...
	public Jugador(float x, float y, Entrada entrada) {
		super(obtenerFrameInicial(), x, y, Constantes.ACELERACION_JUGADOR, Constantes.FRICCION_JUGADOR,
	...
	protected void actualizarEstado(float delta) {
		...
		switch (estado) {
		case INACTIVO:
			this.updateInactivo(delta);
			break;
		case CAMINANDO:
			this.updateCaminando(delta);
			break;
		case SALTANDO:
			this.updateSaltando(delta);
			break;
		case CAYENDO:
			this.updateCayendo(delta);
			break;
		default:
			break;
		}
