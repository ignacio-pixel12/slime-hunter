...
public class PantallaVictoria implements Screen {
    ...
    public PantallaVictoria(SlimeHunter juego, String nombreJugador, float tiempoPartida) {
        this.juego = juego;
    ...
    public void render(float delta) {
        Gdx.gl.glClearColor(0.02f, 0.1f, 0.02f, 1f);
        ...
        this.fontTitulo.setColor(Color.GREEN);
        this.fontTitulo.getData().setScale(3f);
        GlyphLayout tituloLayout = new GlyphLayout(this.fontTitulo, "VICTORIA");
        ...
        GlyphLayout volverLayout = new GlyphLayout(this.fontInfo, "[ Presiona ENTER para volver ]");
        this.fontInfo.draw(this.juego.getBatch(), volverLayout,
            centroX - volverLayout.width / 2f, centroY - 80);
